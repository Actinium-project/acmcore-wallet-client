...
var BitcorePayPro = require('acmcore-payment-protocol');

var BWS = require('acmcore-wallet-service');
...
describe('client API', function() {
  ...
  describe('Network fees', function() {
    it('should get current fee levels for ACM', function(done) {
      ...
      clients[0].credentials = {};
      clients[0].getFeeLevels('acm', 'livenet', function(err, levels) {
        should.not.exist(err);
        should.exist(levels);
  ...
  describe('Transaction Proposal signing', function() {
    ...
    describe('ACM', function(done) {
      beforeEach(function(done) {
        setup(2, 3, 'acm', 'testnet', done);
      });
  ...
  describe('Payment Protocol', function() {
        ...
        helpers.createAndJoinWallet(clients, 2, 2, function(w) {
          clients[0].createAddress(function(err, x0) {
            ...
            clients[0].fetchPayPro(opts, function(err, paypro) {
              http.getCall(0).args[0].coin.should.equal('acm');
    ...
    describe('1-of-1 BCH wallet', function() {
      ...
      // note this is using BCH with ACM format testnet address
      beforeEach(function(done) {
        http = sinon.stub();
