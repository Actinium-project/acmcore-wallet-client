...
//console.log('[paypro.js.21]', k,v); //TODO
  ...
  it('Create a PP payment', function() {
    ...
    var payment = PayPro._createPayment(data.merchant_data, '12ab1234', 'mwRGmB4NE3bG4EbXJKTHf8uvodoUtMCRhZ', 100, 'acm');
    var s = '';
  ...
  it('Send a PP payment (browser, ACM)', function(done) {
    var data = TestData.payProData;
    var opts = {
